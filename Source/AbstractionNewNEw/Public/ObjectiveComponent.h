...
class ABSTRACTIONNEWNEW_API UObjectiveComponent : public UActorComponent
{
	GENERATED_BODY()
...
public:
	...
	DECLARE_EVENT_TwoParams(FOjbectiveComponent, FStateChanged, UObjectiveComponent*, EObjectiveState)
